...
// עמוד הפתיחה הוא **הלוז** ולא הדירוג (החלטת המשתמשת 25.8). מי שנכנסת
// לקישור רוצה לדעת מתי ומול מי היא משחקת; הדירוג מעניין אחרי המשחק, לא
// לפניו. למנהלת זה גם עמוד העבודה — לוח הגרירה והזנת התוצאות.
let page = 'schedule';
